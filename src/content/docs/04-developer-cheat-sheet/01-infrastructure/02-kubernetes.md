...
```bash
k3s kubectl exec -it <pod-name> -n <namespace> -- <command>
```
...
> You need the pod name and the ports you want to forward.
>
> Get pod name with:
...
> You need the pod name(s) or label selector and namespace.
>
> List pods first:
